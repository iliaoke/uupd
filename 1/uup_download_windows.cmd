@echo off
:: Generated on 2025-06-12 04:32:19 GMT
...
:START_PROCESS
title 26100.4351_amd64_zh-cn_professional_bf559fe4 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=bf559fe4-c487-44b6-aaaa-c4b36e687028&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
