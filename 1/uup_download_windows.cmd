@echo off
:: Generated on 2024-08-26 14:53:48 GMT
...
:START_PROCESS
title 26100.1586_amd64_zh-cn_professional_7db0a8d0 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=7db0a8d0-e2b9-48c8-8d7b-e34e431f0954&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
