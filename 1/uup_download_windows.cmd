@echo off
:: Generated on 2024-07-09 12:21:27 GMT
...
:START_PROCESS
title 26100.1000_amd64_zh-cn_professional_72063df2 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=72063df2-4506-4410-90d4-a7f9c4920518&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
