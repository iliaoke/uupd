@echo off
:: Generated on 2025-06-29 11:01:00 GMT
...
:START_PROCESS
title 26100.4484_amd64_zh-cn_professional_73d4be2f download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=73d4be2f-c31f-4970-87e6-f391913ebd3d&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
