@echo off
:: Generated on 2025-02-11 06:58:33 GMT
...
:START_PROCESS
title 26100.3037_amd64_zh-cn_professional_06d17592 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=06d17592-50b4-46a2-86a2-39dc827e476d&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
